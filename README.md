...
This repository contains a new generative model of chatbot based on seq2seq modeling. In the case of publication using ideas or pieces of codes from this repository, please kindly cite as detailed here: https://zenodo.org/record/825303/export/hx#.WdbN3luCyUk
